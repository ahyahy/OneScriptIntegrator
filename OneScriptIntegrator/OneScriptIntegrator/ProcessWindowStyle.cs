...
namespace osi
{
    [ContextClass("ОсиСтильОкнаПроцесса", "OsiProcessWindowStyle")]
    public class OsiProcessWindowStyle : AutoContext<OsiProcessWindowStyle>, ICollectionContext, IEnumerable<IValue>
    {
