...
namespace osi
{
    [ContextClass("ОсиФильтрыУведомления", "OsiNotifyFilters")]
    public class OsiNotifyFilters : AutoContext<OsiNotifyFilters>, ICollectionContext, IEnumerable<IValue>
    {
